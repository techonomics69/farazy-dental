    ...
    <div class="content-wraper">
        ...
        <div class="white-box">
            <form action="{{ route('wirehouse.update-product-demand',['id' => $product_demand->id]) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="req_no_auto" value="{{ $product_demand->req_no_auto }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <edit-product-requisition :items="{products:{{ $products  }},units:{{ $units }},productSets: {{ $product_sets }},demandProducts: {{ $demand_products }} }"></edit-product-requisition>
