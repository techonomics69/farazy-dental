        ...
        <div class="white-box mb-20">
            ...
            @if($chalan)
                <p>
                    ...
                    <span class="text-warning">| <strong>Product Return No #</strong> {{ $chalan->productReturn->ret_no_auto  }} / {{ $chalan->productReturn->ret_no_manual  }}</span>
