...
@section('title')
    <div>
        <div class="content-wraper">
            <div class="white-box">
                <div class="box-title m-b-20">CREATE DOCTOR</div>
                <hr>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="form-body">
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="firstName" name="mobile" class="form-control" value="{{ old('mobile') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="appoint_time" name="appoint_time" class="form-control" value="{{ old('appoint_time') }}">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4 text-center">
                                        <img src="" class="img-responsive" id="uploadPreview" alt="">
                                    </div>
                                </div>
