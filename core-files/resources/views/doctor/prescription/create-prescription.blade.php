...
@section('content')
    ...
    <div class="content-wraper">
        <div class="white-box mb-10">
            <h3 class="box-title text-success mb-0">CREATE PRESCRIPTION</h3>
        </div>

        <form action="{{ route('post-create-prescription') }}" method="post">
            {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="prescription_id" class="form-control" value="{{ $prescription_id }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline"><input type="radio" name="gender">F</label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <textarea name="rx"  cols="30" rows="5" class="form-control" style="margin-top:15px"></textarea>
                </div>

                <create-prescription :items="{medicines: {{ $medicines }},tests: {{ $tests }}, advices: {{ $advices }} }"></create-prescription>
