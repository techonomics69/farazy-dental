...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuejs_paginate__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuejs_datepicker__ = __webpack_require__(37);
...
Vue.component('specialist', __webpack_require__(41));
Vue.component('appointment', __webpack_require__(44));
Vue.component('create-prescription', __webpack_require__(47));
Vue.component('appointment-list', __webpack_require__(50));
...
Vue.component('datepicker', __WEBPACK_IMPORTED_MODULE_2_vuejs_datepicker__["a" /* default */]);
...
Component.options.__file = "resources/assets/js/components/Specialist.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0e2883b0", Component.options)
  } else {
    hotAPI.reload("data-v-0e2883b0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        togleDepartment: function togleDepartment(val) {
            console.log(val);
            if (this.checkedDepartments.includes(val)) {
                var i = this.checkedDepartments.indexOf(val);
        ...
        paginate: function paginate(pageNo) {
  ...
  return _c("section", [
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-sm-12 col-md-9 blog-pull-right" }, [
          _c(
            "div",
            { staticClass: "row multi-row-clearfix" },
            _vm._l(_vm.displayedDoctors, function(specialist) {
              return _c(
                "div",
                { staticClass: "col-sm-6 col-md-4 mb-60 sm-text-center" },
                [
                  _c("div", { staticClass: "team maxwidth400" }, [
                    _c("div", { staticClass: "thumb" }, [
                      _c("img", {
                        staticClass: "img-fullwidth",
                        attrs: { src: specialist.photo, alt: "" }
                      })
                    ]),
                    _vm._v(" "),
                    _c(
                      "div",
                      { staticClass: "content border-1px p-15 bg-white-light" },
                      [
                        _c("h4", { staticClass: "name mb-0 mt-0" }, [
                          _vm._v(_vm._s(specialist.name))
                        ]),
                        _vm._v(" "),
                        specialist.department
                          ? _c("h6", { staticClass: "title mt-0" }, [
                              _vm._v(_vm._s(specialist.department.title))
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                        _c("h6", { staticClass: "title mt-0" }, [
                          _vm._v(_vm._s(specialist.specialization))
                        ]),
                        _vm._v(" "),
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "btn btn-theme-colored btn-sm pull-right flip",
                            attrs: { href: "get-appointment/" + specialist.id }
                          },
                ...
                [
                  _c("paginate", {
                    attrs: {
                      ...
                      "next-text": "Next",
                      "container-class":
                        "pagination theme-colored pull-right pull-sm-center"
                    }
                  })
                ],
                1
        ...
        _c("div", { staticClass: "col-sm-12 col-md-3" }, [
          _c("div", { staticClass: "sidebar sidebar-left mt-sm-30" }, [
            _c("div", { staticClass: "widget" }, [
              _c("h5", { staticClass: "widget-title line-bottom" }, [
                _vm._v("Select Departments")
              ]),
              _vm._v(" "),
              _vm.departments.length
                ? _c(
                    "ul",
                    { staticClass: "list list-divider list-border" },
                            ...
                            _c("input", {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.togleDepartment(department.id)
                                }
                              }
                            }),
                            _vm._v(" "),
                            _c("label", [_vm._v(_vm._s(department.title))])
                          ]
                        )
                      ])
                    }),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0e2883b0", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/Appointment.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2d5be7b8", Component.options)
  } else {
    hotAPI.reload("data-v-2d5be7b8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        loadSchedule: function loadSchedule() {
            ...
            axios.get('/all-appointment/' + did + '/' + this.appointmentDate).then(function (response) {
        ...
        serialExist: function serialExist(i) {
    ...
    created: function created() {
        ...
        var app = this;
        var visibleDates = this.disabled_days.map(function (v, i) {
            return parseInt(v);
        });
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "row" }, [
      ...
      _c("div", { staticClass: "col-md-6" }, [
        _c(
          ...
          [
            _c("label", [_vm._v("Appointment Date")]),
            _vm._v(" "),
            _c("datepicker", {
              attrs: {
              ...
              model: {
                value: _vm.appointmentsDate,
                callback: function($$v) {
                  _vm.appointmentsDate = $$v
                },
                expression: "appointmentsDate"
              }
            }),
            _vm._v(" "),
            _c("input", {
              attrs: { type: "hidden", name: "appointment_date" },
    ...
    _vm._v(" "),
    _c("div", { staticClass: "appointment-list" }, [
      _c(
        "div",
        { staticClass: "form-group" },
        _vm._l(_vm.max_appointment, function(i) {
          return _c(
            "label",
            { staticClass: "radio-inline col-sm-4 col-md-2" },
            [
              _c("input", {
                attrs: {
                  type: "radio",
                  name: "sl_no",
                  disabled: _vm.serialExist(i)
                },
                domProps: { value: i }
              }),
              _vm._v("SL " + _vm._s(i) + "\n            ")
    ...
    return _c("div", { staticClass: "col-md-6" }, [
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("input", {
          ...
          attrs: { type: "text", name: "patient_name", required: "" }
        })
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "col-md-6" }, [
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("input", {
          staticClass: "form-control",
          attrs: { type: "text", name: "contact_no", required: "" }
        })
      ])
    ])
  },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2d5be7b8", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/CreatePrescription.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ed771aa6", Component.options)
  } else {
    hotAPI.reload("data-v-ed771aa6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        selectMedicine: function selectMedicine(index) {
            var item = this.filteredMedicines[index];
            item.doses = "";
            item.duration = "";
            item.checked = false;
        ...
        selectTest: function selectTest(index) {
            var item = this.filteredTests[index];
            this.testLists.push(item);
            this.filteredTests.splice(index, 1);
            this.removeTest(item.id);
        },
        selectAdvice: function selectAdvice(index) {
            var item = this.filteredAdvices[index];
            this.adviceLists.push(item);
            this.filteredAdvices.splice(index, 1);
            this.removeTest(item.id);
        },

        deSelectMedicine: function deSelectMedicine(index) {
            var item = this.medicineLists[index];
        ...
        deSelectTest: function deSelectTest(index) {
            var item = this.testLists[index];
            this.testLists.splice(index, 1);
            this.addTest(item);
        },
        deSelectAdvice: function deSelectAdvice(index) {
            var item = this.adviceLists[index];
        ...
        removeTest: function removeTest(id) {
        ...
        removeAdvice: function removeAdvice(id) {
        ...
        addAdvice: function addAdvice(item) {
        ...
        searchMedicines: function searchMedicines() {
            ...
            if (this.medicineText.length) {
                ...
                this.filteredMedicines = this.medicines.filter(function (item) {
        ...
        searchTests: function searchTests() {
            var app = this;
            if (this.testText.length) {
                this.filteredTests = [];
                this.filteredTests = this.tests.filter(function (item) {
        ...
        searchAdvice: function searchAdvice() {
            var app = this;
            if (this.adviceText.length) {
                this.filteredAdvices = [];
                this.filteredAdvices = this.tests.filter(function (item) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "prescription-details" }, [
    _c("h3", { staticClass: "box-title" }, [
      _vm._v("WRITE YOUR PRESCRIPTION DETAILS")
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "row" }, [
        ...
        _c("div", { staticClass: "tab-content" }, [
          _c(
            "div",
            {
              ...
              attrs: { role: "tabpanel", id: "medicine" }
            },
            [
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.medicineText,
                      expression: "medicineText"
                    }
                  ],
                  staticClass: "form-control",
                  attrs: { type: "text", placeholder: "Search Medicine" },
                  domProps: { value: _vm.medicineText },
                  on: {
                    keyup: _vm.searchMedicines,
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.medicineText = $event.target.value
                    }
                  }
                })
              ]),
              _vm._v(" "),
              _vm.filteredMedicines.length
                ? _c(
                    "ul",
                    { staticClass: "list-group" },
                    _vm._l(_vm.filteredMedicines, function(medicine, index) {
                      return index < 10
                        ? _c(
                            "li",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.selectMedicine(index)
                                }
                              }
                            },
                            [
            ...
            [
              _c("div", { staticClass: "form-grup" }, [
                _c("input", {
                  ...
                  staticClass: "form-control",
                  attrs: { type: "text", placeholder: "Search Medicine" },
                  domProps: { value: _vm.testText },
                  on: {
                    keyup: _vm.searchTests,
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.testText = $event.target.value
                    }
                  }
                })
              ]),
              _vm._v(" "),
              _vm.filteredTests.length
                ? _c(
                    "ul",
                    { staticClass: "list-group" },
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.adviceText,
                      expression: "adviceText"
                    }
                  ],
                  staticClass: "form-control",
                  attrs: { type: "text", placeholder: "Search Medicine" },
                  domProps: { value: _vm.adviceText },
                  on: {
                    keyup: _vm.searchAdvice,
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.adviceText = $event.target.value
                    }
                  }
                })
              ]),
              _vm._v(" "),
              _vm.filteredAdvices.length
                ? _c(
                    "ul",
                    { staticClass: "list-group" },
                    _vm._l(_vm.filteredAdvices, function(advice, index) {
                      return index < 10
                        ? _c(
                            "li",
                            {
      ...
      _vm._v(" "),
      _c("div", { staticClass: "col-md-8" }, [
        _c("table", { staticClass: "table table-bordered mb-15" }, [
          _vm._m(1),
          _vm._v(" "),
          _c(
            "tbody",
            _vm._l(_vm.medicineLists, function(medicine, index) {
              return _vm.medicineLists.length
                ? _c("tr", [
                    _c("td", [
                      _c(
                        "span",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.deSelectMedicine(index)
                            }
                          }
                        },
                        [_vm._v("X")]
                    ...
                    _c("td", [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.medicineLists[index].id,
                            expression: "medicineLists[index].id"
                          }
                        ],
                        attrs: {
                          type: "hidden",
                        ...
                        domProps: { value: _vm.medicineLists[index].id },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.medicineLists[index].doses,
                            expression: "medicineLists[index].doses"
                          }
                        ],
                        staticClass: "form-control table-input",
                        attrs: {
                          type: "text",
                          name: "medicine[" + index + "][doses]",
                          required: ""
                        },
                        domProps: { value: _vm.medicineLists[index].doses },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                    ...
                    _c("td", [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.medicineLists[index].duration,
                            expression: "medicineLists[index].duration"
                          }
                        ],
                        staticClass: "form-control table-input",
                        attrs: {
                        ...
                        domProps: { value: _vm.medicineLists[index].duration },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                      ...
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.medicineLists[index].checked,
                            expression: "medicineLists[index].checked"
                          }
                        ],
                        staticClass: "form-control table-input",
                        attrs: {
                          type: "checkbox",
                          name: "medicine[" + index + "][before]"
                        },
                        domProps: {
                          value: _vm.medicineLists[index].checked,
                          checked: Array.isArray(
                            _vm.medicineLists[index].checked
                          )
                            ? _vm._i(
                                _vm.medicineLists[index].checked,
                                _vm.medicineLists[index].checked
                        ...
                        on: {
                          change: function($event) {
                            var $$a = _vm.medicineLists[index].checked,
                              $$el = $event.target,
                              $$c = $$el.checked ? true : false
                            if (Array.isArray($$a)) {
                              var $$v = _vm.medicineLists[index].checked,
                                $$i = _vm._i($$a, $$v)
                              if ($$el.checked) {
                                $$i < 0 &&
                                  _vm.$set(
                              ...
                              _vm.$set(_vm.medicineLists[index], "checked", $$c)
                            }
                          }
                        }
                      })
        ...
        _c("table", { staticClass: "table table-bordered mb-15" }, [
          ...
          _c(
            "tbody",
            _vm._l(_vm.testLists, function(test, index) {
              return _vm.testLists.length
                ? _c("tr", [
                    _c("td", [
                      _c(
                        "span",
                    ...
                    _c("td", [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.testLists[index].id,
                            expression: "testLists[index].id"
                          }
                        ],
                        attrs: {
                          type: "hidden",
                        ...
                        domProps: { value: _vm.testLists[index].id },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
        ...
        _c("table", { staticClass: "table table-bordered mb-15" }, [
          _c("thead", [
            _c("tr", [
              ...
              _vm._v(" "),
              _c("th", [_vm._v("Necessary Advices")])
            ])
          ]),
          _vm._v(" "),
          _c(
            "tbody",
            _vm._l(_vm.adviceLists, function(advice, index) {
              return _vm.adviceLists.length
                ? _c("tr", [
                    _c("td", [
                      _c(
                        "span",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.deSelectAdvice(index)
                            }
                          }
                        },
                        [_vm._v("X")]
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.adviceLists[index].id,
                            expression: "adviceLists[index].id"
                          }
                        ],
                        attrs: {
                          type: "hidden",
                          name: "advice[" + index + "][id]"
                        },
                        domProps: { value: _vm.adviceLists[index].id },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "ul",
      { staticClass: "nav customtab nav-tabs", attrs: { role: "tablist" } },
      [
        _c("li", { staticClass: "active", attrs: { role: "presentation" } }, [
          _c(
            ...
            [
              ...
              _c("span", { staticClass: "hidden-xs" }, [_vm._v("Medicine")])
            ]
          )
        ]),
        _vm._v(" "),
        _c("li", { attrs: { role: "presentation" } }, [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("span", { staticClass: "hidden-xs" }, [_vm._v("Test")])
            ]
          )
        ]),
        _vm._v(" "),
        _c("li", { attrs: { role: "presentation" } }, [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("span", { staticClass: "hidden-xs" }, [_vm._v("Advice")])
            ]
          )
        ])
      ]
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("thead", [
      _c("tr", [_c("th", { attrs: { colspan: "5" } }, [_vm._v("Medication")])]),
      _vm._v(" "),
      _c("tr", [
        _c("th", { staticClass: "width-50" }, [_vm._v("X")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ed771aa6", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/AppointmentList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4363ed76", Component.options)
  } else {
    hotAPI.reload("data-v-4363ed76", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        setDoctorId: function setDoctorId(val) {
            this.doctorId = val.value;
        },
        getAppointmentLists: function getAppointmentLists() {
            var _this = this;
            ...
            this.appointments = [];
            axios.get('/all-appointment-list/' + app.doctorId + '/' + app.appointmentDate).then(function (response) {
        ...
        setOptionsData: function setOptionsData(doctors) {
            var doctorsData = [];
        ...
        "form",
        {
          on: {
            submit: function($event) {
              ...
              return _vm.getAppointmentLists($event)
            }
          }
        },
        [
          ...
          _c("div", { staticClass: "col-md-2" }, [
            _c("div", { staticClass: "form-group text-right" }, [
              ...
              _c(
                "button",
                {
                  staticClass: "btn btn-success flat",
                  staticStyle: { "margin-top": "25px" },
                  attrs: { type: "button" },
                  on: { click: _vm.getAllAppointments }
                },
                [_vm._v("All")]
              )
            ])
            ...
            _c(
              ...
              _vm._l(_vm.appointments, function(item, index) {
                return _c("tr", [
                  ...
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.doctor.name))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.patient_name))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.contact_no))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.appointment_date))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.sl_no))])
                ])
              }),
              0
            )
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { staticStyle: { width: "50px" } }, [_vm._v("SL")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4363ed76", module.exports)
  }
}
